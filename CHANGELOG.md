...
`Luminance` unit. Many thanks to [adamreichold](https://github.com/adamreichold) and
[AnickaBurova](https://github.com/AnickaBurova) for pull requests included and issues resolved in
this release.

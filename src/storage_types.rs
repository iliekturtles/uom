...
macro_rules! storage_types_type {
    ...
    ($attr:tt $vis:vis All $tt:tt) => {
        storage_types_type!($attr $vis usize $tt);
        storage_types_type!($attr $vis u8 $tt);
        storage_types_type!($attr $vis u16 $tt);
        storage_types_type!($attr $vis u32 $tt);
        storage_types_type!($attr $vis u64 $tt);
        storage_types_type!($attr $vis u128 $tt);
        storage_types_type!($attr $vis isize $tt);
        storage_types_type!($attr $vis i8 $tt);
        storage_types_type!($attr $vis i16 $tt);
        storage_types_type!($attr $vis i32 $tt);
        storage_types_type!($attr $vis i64 $tt);
        storage_types_type!($attr $vis i128 $tt);
        storage_types_type!($attr $vis BigInt $tt);
        storage_types_type!($attr $vis BigUint $tt);
        storage_types_type!($attr $vis Rational $tt);
        storage_types_type!($attr $vis Rational32 $tt);
        storage_types_type!($attr $vis Rational64 $tt);
        storage_types_type!($attr $vis BigRational $tt);
        storage_types_type!($attr $vis Complex32 $tt);
        storage_types_type!($attr $vis Complex64 $tt);
        storage_types_type!($attr $vis f32 $tt);
        storage_types_type!($attr $vis f64 $tt);
    };
